...
import { api, catColor, sevColor, bandColor, LANGS, SAMPLES } from '../lib/api'
  ...
  return (
    <div className="glass" style={{ padding: 18 }}>
      ...
      <div style={{ display: 'flex', gap: 8, marginTop: 12, flexWrap: 'wrap', alignItems: 'center' }}>
        ...
        {[['AI-style', SAMPLES.ai_python], ['Buggy', SAMPLES.buggy_python], ['Clean', SAMPLES.clean_python]].map(([l, s]) => (
          <button key={l} onClick={() => { setCode(s); setLang('Python') }} className="tag" style={{ cursor: 'pointer' }}>{l}</button>
        ))}
      </div>
    </div>
  )
